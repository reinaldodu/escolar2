  ...
  <div class="row">
        ...
        <div class="col-md-4 text-center border mt-3 p-4 bg-light">
            <div class="card m-2 shadow" style="width: 18rem;">
              <?php if(!file_exists('../profesor/images/laboratorios/'.$data['imagen'])){ ?>
            
              <?php }else{ ?>
                <img src="../profesor/images/laboratorios/<?=$data['imagen'] ?>" style="width: 100%; height: 200px;" class="card-img-top" alt="<?=$data['titulo'] ?>">
              <?php } ?>
              <div class="card-body">
